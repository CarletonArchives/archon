...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
   <head>
      ...
      <!--       Lightbox script -->
      <script type="text/javascript" src="<?php echo($_ARCHON->PublicInterface->ThemeJavascriptPath); ?>/lightbox.js"></script>
         ...
         <div id="researchblock">
            <?php
                     ...
                     if(!$_ARCHON->Security->userHasAdministrativeAccess())
                     {
                        ...
                        echo(" | <a href='?p=core/contact&amp;f=email&amp;referer=" . urlencode($_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']) . "'>Contact Us</a>");
                        if($_ARCHON->Security->isAuthenticated())
                        {
