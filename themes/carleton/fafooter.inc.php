...
<div id="userlogincontrols">
  ...
  <br/><a href="?p=core/register">Register</a>
</div>
...
<?php
    ...
    {
      echo("<div id='repositorylink'><a href='https://apps.carleton.edu/archives/'>{$_ARCHON->Repository->getString('Name')}</a></div>\n");
    }
