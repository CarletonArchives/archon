...
<?php
                  ...
                  if(!$_ARCHON->Security->userHasAdministrativeAccess())
                  {
                     ...
                     if(defined('PACKAGE_COLLECTIONS'))
                     {
                        ...
                        echo("<span id='viewcartlink' class='$class' $hidden>| <a href='?p=collections/research&amp;f=cart&amp;referer=" . urlencode($_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']) . "'>View List (<span id='cartcount'>$EntryCount</span>)</a></span>");
                     }
                  }
?>
               </div>
...
?>
                  <div id="browsebyblock">
                        ...
                        <span class="<?php echo($ClassificationsClass); ?>">
                           <a href="?p=collections/classifications" onclick="js_highlighttoplink(this.parentNode); return true;">Categories</a>
                        </span>
                        <span class="<?php echo($DigitalLibraryClass); ?>">
                           <a href="?p=digitallibrary/thumbnails" onclick="js_highlighttoplink(this.parentNode); return true;">Digital Content</a>
                        </span>
                      <!--Disabled Subject browsing-->
<!--                        <span class="<?php // echo($SubjectsClass); ?>">
                        ...
                        <span class="<?php echo($TitleClass); ?>">
                           <a href="?p=collections/collections" onclick="js_highlighttoplink(this.parentNode); return true;">A-Z</a>
                        </span>
                     </div>
               </div>
